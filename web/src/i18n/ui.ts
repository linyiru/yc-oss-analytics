...
const en = {
  ...
  'trends.movers.title': 'Trending now (commit momentum)',
  'trends.movers.note': 'Most active and fastest-accelerating teams by recent commits. Star momentum is added as growth curves finish backfilling.',
  'trends.movers.active': 'Most active · commits in last 90 days',
  'trends.movers.accel': 'Accelerating · last 30d vs quarter average',
...
const zhHant: Partial<Record<UIKey, string>> = {
  ...
  'trends.movers.title': '當前熱門(commit 動能)',
  'trends.movers.note': '依近期 commit 看最活躍與加速最快的團隊。star 動能將在成長曲線回填完成後加入。',
  'trends.movers.active': '最活躍 · 近 90 天 commit 數',
  'trends.movers.accel': '加速中 · 近 30 天 vs 該季平均',
...
const zhHans: Partial<Record<UIKey, string>> = {
  ...
  'trends.movers.title': '当前热门(commit 动能)',
  'trends.movers.note': '按近期 commit 看最活跃与加速最快的团队。star 动能将在成长曲线回填完成后加入。',
  'trends.movers.active': '最活跃 · 近 90 天 commit 数',
  'trends.movers.accel': '加速中 · 近 30 天 vs 该季平均',
